...
# === Paden naar data ===
BASE_DATA_DIR = Path("Societal_challenge/Data")
...
gdf_energieprojecten = gpd.read_file("Societal_challenge/Data/energieprojecten.gpkg", layer="projecten")
...
gdf_bovenregionaal.to_file("Societal_challenge/cleaned_data/Bovenregionaal.gpkg", layer ="data",driver="GPKG")
print("Aantal regels in combined.csv:", len(gdf_bovenregionaal))
gdf_locatiespecifiek.to_file("Societal_challenge/cleaned_data/Locatiespecifiek.gpkg", layer ="data",driver="GPKG")

print("Aantal regels in combined.csv:", len(gdf_locatiespecifiek))
gdf_energieprojecten.to_file("Societal_challenge/cleaned_data/Energieprojecten.gpkg", layer ="data",driver="GPKG")
gdf_energieprojecten.to_csv("Societal_challenge/cleaned_data/Energieprojecten.csv", index=False)

print("Aantal regels in combined.csv:", len(gdf_energieprojecten))
gdf_bouwwerken.to_file("Societal_challenge/cleaned_data/Bouwwerken.gpkg", layer ="data",driver="GPKG")
...
combined_gdf.to_file("Societal_challenge/cleaned_data/combined.gpkg", layer ="data",driver="GPKG")

combined_gdf.to_csv("Societal_challenge/streamlit2.0/combined.csv")